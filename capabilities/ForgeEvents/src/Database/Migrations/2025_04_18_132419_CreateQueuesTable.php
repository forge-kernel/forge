...
use Capability\ForgeDatabaseSQL\DB\Attributes\Column;
use Capability\ForgeDatabaseSQL\DB\Attributes\GroupMigration;
use Capability\ForgeDatabaseSQL\DB\Attributes\Index;
use Capability\ForgeDatabaseSQL\DB\Attributes\Table;
use Capability\ForgeDatabaseSQL\DB\Attributes\Timestamps;
use Capability\ForgeDatabaseSQL\DB\Enums\ColumnType;
use Capability\ForgeDatabaseSQL\DB\Migrations\Migration;
...
class CreateQueuesTable extends Migration
{
    ...
    #[Column(name: 'metadata', type: ColumnType::JSON, nullable: true, default: null)]
