<?php
?>
<div id="fw-notifications-container" class="fw-notifications-container"></div>

<script>
(function() {
    const container = document.getElementById('fw-notifications-container');
    if (!container) return;
    ...
    function showNotification(message, type = 'info', duration = 5000) {
        ...
        notification.className = 'fw-notification';
        ...
        const closeBtn = notification.querySelector('.fw-notification-close');
        const close = () => {
            notification.classList.add('fw-notification-dismissing');
            setTimeout(() => {
