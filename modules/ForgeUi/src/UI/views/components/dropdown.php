...
if (isset($slots['trigger']) && isset($slots['menu'])) {
    $triggerClasses = merge_classes(['fw-dropdown-trigger'], $class ?? '');
    $menuClasses = merge_classes(['fw-dropdown-menu', 'hidden', 'absolute', 'z-50', 'mt-1', 'min-w-[200px]', 'bg-white', 'rounded-md', 'shadow-lg', 'border', 'border-gray-200', 'py-1'], $class ?? '');
    ?>
