...
<ul class="forge-file-list">
    ...
    <li><span class="forge-file-label">Layout:</span> Resources/views/layouts/main.php, Resources/views/layouts/root.php</li>
    <li><span class="forge-file-label">View:</span> Resources/views/pages/index.php</li>
    <li><span class="forge-file-label">Components:</span> Resources/components/nav-bar.php, Resources/components/footer.php</li>
</ul>
